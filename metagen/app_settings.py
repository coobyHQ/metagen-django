...
REQUESTED_ATTRIBUTES = ['name', 'familyName', 'email', 'metagenCode']

METAGEN_IDENTITY_PROVIDERS = [
    ('agentaid', 'AgentA ID'),
    ('chapterbid', 'ChapterB ID'),
    ('chapteraid', 'ChapterA ID'),
    ('internalaid', 'InternalA ID'),
    ('internalbid', 'InternalB ID'),
    ('metagengridworkz', 'METAGENGridworkz Register.com'),
    ('agentbid', 'AgentB ID')
]
...
class AppSettings(object):
    ...
    @property
    def SP_DOMAIN(self):
        return self._setting('METAGEN_SP_DOMAIN', 'https://metagen.test.com:8000')
    ...
    def SERVICE_NAME(self):
        return self._setting('SERVICE_NAME', 'metagen.test.com:8000')
        ...
        return {
            "security": {
                ...
                "requestedAuthnContext": [
                    "https://metagen-testenv-identityserver/MetaGenL2"
                ]
            },
            "contactPerson": {
                "technical": {
...
app_settings = AppSettings('METAGEN_')
